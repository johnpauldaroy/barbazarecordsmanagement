-- Recommendation candidates ranked per barangay and program.
-- Barangay secretaries only see households in their assigned barangay through
-- can_access_barangay; admins can view recommendations across barangays.

export const portalSections = [
  ...
  },
  {
    ...
    path: '/land-map',
    eyebrow: 'Geo View',
    summary: 'Map of household locations with social-program color tagging across Barbaza.',
  },
  {
    id: 'reports',
    label: 'Reports',
...
export const householdRows = [
  {
    ...
    openCases: '2',
    purokSitio: 'Purok 3',
    addressLine1: 'Poblacion, Barbaza, Antique',
    headLastName: 'Dela Cruz',
    headFirstName: 'Maria',
    headMiddleName: 'C.',
    headSuffix: '',
    headDateOfBirth: '1978-04-15',
    headGender: 'Female',
    headCivilStatus: 'Widowed',
    headReligion: 'Roman Catholic',
    headContactNumber: '09171234567',
    headSchoolBackground: 'Not currently studying',
    headOccupation: 'Small vendor / sari-sari store',
    headMonthlyIncome: '5000',
    familyMembers: [
      {
        _id: 'hh-pbl-m1',
        lastName: 'Dela Cruz',
        ...
        contactNumber: '',
        schoolBackground: 'Barbaza National High School',
        occupation: 'Student',
        monthlyIncome: '0',
      },
      {
  ...
  },
  {
    ...
    headMiddleName: 'P.',
    headSuffix: '',
    headDateOfBirth: '1972-11-03',
    headGender: 'Male',
    headCivilStatus: 'Married',
    headReligion: 'Roman Catholic',
    headContactNumber: '09189876543',
    headSchoolBackground: 'Not currently studying',
    headOccupation: 'Construction worker / tricycle driver',
    ...
    familyMembers: [
      {
        ...
        schoolBackground: 'Not currently studying',
  ...
  },
  {
    ...
    headMiddleName: 'B.',
    headSuffix: '',
    headDateOfBirth: '1968-09-27',
    headGender: 'Female',
    headCivilStatus: 'Married',
    headReligion: 'Roman Catholic',
    headContactNumber: '09224445566',
    headSchoolBackground: 'Not currently studying',
    headOccupation: 'Fishing and sari-sari store',
  ...
  },
  {
    ...
    headMiddleName: 'L.',
    headSuffix: '',
    headDateOfBirth: '1965-03-20',
    headGender: 'Female',
    headCivilStatus: 'Widowed',
    headReligion: 'Iglesia ni Cristo',
    headContactNumber: '09308889900',
    headSchoolBackground: 'Not currently studying',
    headOccupation: 'Laundry service / farm labor',
    ...
    familyMembers: [
      {
        ...
        contactNumber: '',
        schoolBackground: 'Not currently studying',
        occupation: 'Seasonal farm laborer',
        monthlyIncome: '3500',
      },
      {
        _id: 'hh-alo-m2',
...
export const userRoles = [
  { key: 'admin', name: 'Admin', description: 'Can review, check, and approve assistance applications.' },
  { key: 'barangay_secretary', name: 'Barangay Secretary', description: 'Can add, edit, and delete households and handle assistance applications.' },
];
...
export const settingsGroups = [
  {
    title: 'Access roles',
    items: [
      'Barangay Secretary: household management and application intake',
      'Admin: review, check, and approve assistance applications',
    ],
  },
  {
...
export const householdRegistrySummary = {
  totalResidents: 1847,
  totalHouseholds: 412,
  tupadPriorityHouseholds: 138,
  indigentHouseholds: 54,
  lumonHouseholds: 38,
  householdsWithActiveCases: 94,
};

export const incomeClassificationBreakdown = [
  { key: 'no_income',       label: 'No Income / No Work', count: 54,  percentage: 13 },
  { key: 'low_income',      label: 'Low Income',           count: 84,  percentage: 20 },
...
export const applicationsByProgram = [
  ...
  { program: 'TUPAD',        total: 136, pending: 32, approved: 76,  released: 28 },
  { program: 'Food Support', total: 88,  pending: 22, approved: 48,  released: 18 },
  { program: 'Other',        total: 52,  pending: 14, approved: 28,  released: 10 },
];
